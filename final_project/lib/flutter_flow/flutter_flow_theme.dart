...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF5C19DB);
  late Color secondary = const Color(0xFF36B4FF);
  late Color tertiary = const Color(0x9A30DEFF);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x545C19DB);
  late Color accent2 = const Color(0x4D36B4FF);
  late Color accent3 = const Color(0x5B30DEFF);
